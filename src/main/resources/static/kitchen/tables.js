    ...
    methods: {
        ...
        post_dish:function (){
            ...
            axios({
                ...
                url: "http://localhost:8080/dish/insert?did="+this.message.did+"&name="+this.message.name+"&type="+this.message.type+"&describe="+this.message.describe+"&cost="+this.message.cost+"&price="+this.message.price,
                headers:{
